...
**Status: IMPLEMENTIERT (2026-07-05). Verhaltensneutral -- volle Suite 203/203 (193 + 10 Contract-Tests), KEINE geaenderten Test-Erwartungen.**

## Phase 0 — Vorab-Check (vor jeder Code-Änderung)

- [x] **T001** `grep -rn "_find_leak\|_READ_HINTS\|_MUTATE_HINTS\|_LEAK_PATTERNS
...
- [x] **T002** `tests/test_dynamic_helpers.py` (rot): `is_read_tool`
...
- [x] **T003** `mcpfrisk/checks/_dynamic_helpers.py` anlegen: `READ_HINTS`,
...
- [x] **T004** `schema_fuzzing.py`, `error_leakage.py`, `rbac_cross_tenant.py`,
...
- [x] **T005** Volle Suite grün (`pytest -q`), OHNE geänderte Test-
  Erwartungen (reiner Refactor); Finding-Ausgaben aller vier Checks
  unverändert (Dogfood-Stichprobe).
- [x] **T006** `MARKET-RESEARCH.md` korrigieren: §5-Tabelle (JS/TS-Abdeckung
...
- [x] **T007** CONTEXT.md-Architektur (kurzer Hinweis auf `_dynamic_helpers.py`
